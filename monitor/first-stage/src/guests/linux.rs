 ...
 * The  options `iommu=off swiotlb=force`  (combined with the Kernel config). Ensure that Linux does not try to configure DMA remapping, because we manage this in Tyche.
 */
