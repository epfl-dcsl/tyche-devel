...
fn no_children_eri() {
    ...
    snap!(
        "{[0x0, 0x1000 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}",
        regions(d1, engine)
    );
}
...
fn one_carve_eri() {
    ...
    snap!(
        "{[0x500, 0x1000 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}",
        regions(d1, engine)
    );
    snap!(
        "{[0x0, 0x500 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}",
        regions(d0, engine)
    );
}
...
fn carve_lose_permissions() {
    ...
    snap!(
        "{[0x0, 0x500 | 1 (1 - 0 - 0 - 0 - RAM.(ALL 1))] -> [0x500, 0x1000 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}",
        regions(d0, engine)
    );
    snap!(
...
fn carve_access_rights() {
    ...
    let r1 = engine
        ...
        .unwrap();
    snap!(
        "{[0x0, 0x1 | 1 (1 - 1 - 0 - 0 - RAM.(ALL 1))] -> [0x1, 0x5 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}",
        regions(d0, engine)
    );
    snap!(
...
fn simple_alias() {
    ...
    snap!(
        "{[0x0, 0x500 | 2 (2 - 2 - 2 - 2 - RAM.(ALL 2))] -> [0x500, 0x1000 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}",
        regions(d0, engine)
    );
...
fn double_alias() {
    ...
    snap!(
        "{[0x0, 0x500 | 3 (3 - 3 - 3 - 3 - RAM.(ALL 3))] -> [0x500, 0x1000 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}",
        regions(d0, engine)
    );
}
...
fn alias_recursive_chop() {
    ...
    snap!("{[0x0, 0x1 | 5 (5 - 5 - 5 - 5 - RAM.(ALL 5))] -> [0x1, 0x2 | 4 (4 - 4 - 4 - 4 - RAM.(ALL 4))] -> [0x2, 0x3 | 3 (3 - 3 - 3 - 3 - RAM.(ALL 3))] -> [0x3, 0x4 | 2 (2 - 2 - 2 - 2 - RAM.(ALL 2))] -> [0x4, 0x5 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}", regions(d0, engine));
    // TODO(Charly): that's not a lot of useful information really.
...
fn alias_access_rights() {
    ...
    let r1 = engine
        ...
        .unwrap();
    snap!(
        "{[0x0, 0x1 | 2 (2 - 2 - 1 - 1 - RAM.(ALL 2))] -> [0x1, 0x5 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}",
        regions(d0, engine)
    );
    snap!(
...
fn alias_then_carve() {
    ...
    snap!(
        "{[0x0, 0x5 | 2 (2 - 1 - 1 - 1 - RAM.(ALL 2))] -> [0x5, 0xa | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}",
        regions(d0, engine)
    );
...
fn enclave_steal_via_alias() {
    ...
    snap!("{[0x0, 0x1 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))] -> [0x1, 0x2 | 2 (2 - 2 - 2 - 2 - RAM.(ALL 2))] -> [0x2, 0x5 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}", regions(d1, engine));
...
fn enclave_steal_via_carve() {
    ...
    snap!("{[0x0, 0x1 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))] -> [0x1, 0x2 | 1 (1 - 0 - 0 - 0 - RAM.(ALL 1))] -> [0x2, 0x5 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}", regions(d1, engine));
    // Check the parent only has the second part of the address space.
    snap!(
        "{Region([0x0, 0xa | PURWXS | RAM.(ALL)]), Management(2 | _), RegionRevoke([0x0, 0x5 | CRWXS | RAM.(ALL)])}",
        capas(d0, engine)
...
fn enclave_enclave_steal() {
    ...
    snap!(
        "{[0x0, 0x1 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))] -> [0x2, 0x5 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}",
        regions(d1, engine)
    );
    // Check the parent only has the second part of the address space.
    snap!(
...
fn new_capa() {
    ...
    snap!("{[0x0, 0x10 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))] -> [0x10, 0x20 | 2 (2 - 2 - 2 - 2 - RAM.(ALL 2))] -> [0x20, 0x100 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}", regions(d0, engine));
    ...
    snap!("{[0x0, 0x10 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))] -> [0x10, 0x20 | 2 (2 - 2 - 2 - 2 - RAM.(ALL 2))] -> [0x20, 0x40 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))] -> [0x40, 0x50 | 2 (2 - 2 - 2 - 2 - RAM.(ALL 2))] -> [0x50, 0x100 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}", regions(d0, engine));
    ...
    snap!("{[0x0, 0x40 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))] -> [0x40, 0x50 | 2 (2 - 2 - 2 - 2 - RAM.(ALL 2))] -> [0x50, 0x100 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}", regions(d0, engine));
    snap!(
        "{Region([0x10, 0x20 | __RWXS | RAM.(ALL)])}",
        capas(d1_capa, engine)
    );
    snap!(
        "{[0x10, 0x20 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}",
    ...
    snap!(
        "{[0x0, 0x30 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))] -> [0x40, 0x100 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}",
        regions(d0, engine)
    );
    snap!(
    ...
    snap!(
        "{[0x10, 0x20 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))] -> [0x30, 0x50 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}",
        regions(d1_capa, engine)
    );
    ...
    snap!(
        "{[0x0, 0x30 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))] -> [0x50, 0x100 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}",
        regions(d0, engine)
    );
    snap!(
    ...
    snap!(
        "{[0x0, 0x30 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))] -> [0x50, 0x60 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))] -> [0x80, 0x100 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}",
        regions(d0, engine)
    );
    snap!(
    ...
    snap!(
        "{[0x40, 0x50 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))] -> [0x60, 0x80 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}",
        regions(d2_capa, engine)
    );
    ...
    snap!(
        "{[0x60, 0x80 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}",
        regions(d2_capa, engine)
    );
    snap!(
        "{[0x0, 0x60 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))] -> [0x80, 0x100 | 1 (1 - 1 - 1 - 1 - RAM.(ALL 1))]}",
        regions(d0, engine)
    );
